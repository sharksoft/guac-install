...
# Install Features
apt-get update
apt-get -y install build-essential libpng-dev libcairo2-dev libjpeg-turbo8-dev libossp-uuid-dev libavcodec-dev libavutil-dev \
libswscale-dev  libpango1.0-dev libssh2-1-dev libtelnet-dev libvncserver-dev libpulse-dev libssl-dev \
libvorbis-dev libwebp-dev mysql-server mysql-client mysql-common mysql-utilities tomcat8  ghostscript jq wget curl
